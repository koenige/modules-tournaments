...
INSERT INTO categories (`category`, `description`, `main_category_id`, `path`, `parameters`, `sequence`, `last_update`) VALUES ('Status', NULL, (SELECT category_id FROM categories c WHERE path = 'tournaments'), 'tournaments/status', '&alias=tournaments/status&form_type_self=1&zzform[form_display]=set&zzform[min_records]=1&zzform[max_records]=10', NULL, NOW());
