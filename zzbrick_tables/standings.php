 ...
 * @copyright Copyright © 2012-2015, 2019-2026 Gustaf Mossakowski
...
$zz['fields'][1]['field_name'] = 'standing_id';
$zz['fields'][1]['type'] = 'id';
...
$zz['fields'][4]['title_tab'] = 'Team / Player';
...
$zz['subtitle']['runde_no']['prefix'] = wrap_text('Round ');

$zz['filter'][1]['title'] = wrap_text('Type');
$zz['filter'][1]['identifier'] = 'typ';
$zz['filter'][1]['type'] = 'list';
$zz['filter'][1]['where'] = 'team_id';
$zz['filter'][1]['translate_field_value'] = true;
$zz['filter'][1]['selection']['NULL'] = 'Players';
