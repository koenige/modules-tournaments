...
function mod_tournaments_player($vars, $settings, $event) {
	...
	$sql = 'SELECT persons.person_id, participation_id
			...
			, (SELECT identifier FROM contacts_identifiers zps WHERE zps.contact_id = contacts.contact_id AND current = "yes" AND identifier_category_id = %d) AS player_id_dsb
