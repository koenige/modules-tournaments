...
function mod_tournaments_tournamentstats($params, $setting, $data) {
	...
	$sql = 'SELECT events.event_id
			...
			, (SELECT COUNT(nachricht_id) FROM playermessages LEFT JOIN participations ON participations.participation_id = playermessages.teilnehmer_id WHERE participations.event_id = events.event_id) AS tn_nachrichten
